package com.example.SBNZApp.config;
...
import com.example.SBNZApp.security.auth.RestAuthenticationEntryPoint;
import com.example.SBNZApp.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests().antMatchers("/auth/**","/odgovor/**", "/destinacija/**", "/izvestaj/**", "/smestaj/**", "/cep/**", "/putovanja/**").permitAll()
